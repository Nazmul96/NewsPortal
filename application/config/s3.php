...
$ci =& get_instance();
$s3info = $ci->db->select('*')->from('space_setup_tbl')->where('id',1)->get()->row();
...
|
*/
$config['access_key'] = @$s3info->access_key;
...
|
*/
$config['secret_key'] = @$s3info->secret_key;
...
$config['bucket_name'] = @$s3info->bucket_name;
