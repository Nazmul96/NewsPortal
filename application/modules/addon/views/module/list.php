                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <h6 class="fs-17 font-weight-600 mb-0"><?php echo makeString(['add_module'])?></h6>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                         <?php echo form_open_multipart("addon/module/upload/") ?>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5 pr-md-1">
                                            ...
                                            <label class="font-weight-600"><?php echo display('purchase_key') ?> </label>
                                        ...
                                        <div class="col-md-3 px-md-1">
                                            <div class="form-group">
                                                <label class="font-weight-600"><?php echo display('module') ?> (.zip | .rar | .gz)</label>
                                        ...
                                        <div class="col-md-4 pl-md-1">
                                            <div class="form-group">
                                                ...
                                                <div class="pull-left overwrite">
                                                    <input type="checkbox" name="overwrite"  value="false" id="overwrite"> <label for="overwrite" class="font-weight-600"><?php echo display("overwrite") ?></label>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="card-footer">
                                      <div class=" form-group">
                                        <div class="col-md-12 ">
                                            <input type="submit" class="btn btn-md btn-success float-right" name="" value="<?php echo display('add_module');?>">
                                        </div> 
                                     </div>
                                </div>
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?php echo base_url('addon/module/download_module')?>" class="btn btn-success m-b-5 m-r-2 float-right"><i class="fas fa-download"> </i> <?php echo display('download')?></a>
                        </div>
                    </div>
                    ...
                    <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 addonsbox">
                                    <div class="thumbnail">
                                        ...
                                        <div class="caption">
                                            ...
                                            <p class="caption_desc">Note : Dollar rate will be counted as local currency BDT current rate.</p>
                                            <p>
                                ...
                                <?php
                                    ...
                                    $def_mods = ['dashboard','template','advertisement','analytics',
                                    'archive','categories','comments','media_library','menu','news','page','reporter','seo','settings','theme','user','addon','poll','category','RSS_Feed','newsletter'];
                                if (is_array($map))
