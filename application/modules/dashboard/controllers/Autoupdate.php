...
//Get Update file
define('MIN_VERSION', file_get_contents('https://update.bdtask.com/news365/autoupdate/update_min_version'));
//Get Update file
define('MAX_VERSION', file_get_contents('https://update.bdtask.com/news365/autoupdate/update_max_version'));

//Get Update file
define('UPDATE_URL','https://update.bdtask.com/news365/autoupdate');
...
class Autoupdate extends MX_Controller {
    ...
    **/
    ...
    public function cancel_update($version){
        $this->db->set('version',$version)->update('app_settings');
        redirect('dashboard/autoupdate');
    }
