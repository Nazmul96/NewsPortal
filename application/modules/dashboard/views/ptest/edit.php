        ...
        <div class="panel panel-bd ">
            <div class="panel-heading">
                <div class="panel-title">
                    <a href="<?php echo base_url()?>dashboard/Permission_setup/menu_item_list" class="btn btn-sm btn-info pull-right "> Menu Item List</a>
                    <h4>Insert Menu for the application</h4>
                </div>
            </div>
