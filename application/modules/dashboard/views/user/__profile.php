        ...
        <div class="row">
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col ">
                                <img id="output" src="<?php echo  html_escape($img); ?>" class="img-responsive img-thumbnail" width="175">
                            </div>

                            <div class="col-auto margin-top10">
                                <?php
                                    echo form_open_multipart('dashboard/profile/user_photo');
                                ?>
                                        <input type="file" name="user_photo"  id="file-1" class="custom-input-file" accept="image/*">
                                        <label for="file-1">
                                            <i class="fa fa-upload"></i>
                                            <span onClick="searchMform()">Choose a file…</span>
                                        </label>
                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                <h6 class="mb-0 font-weight-600"><?php echo display('nick_name')?></h6>
                            </div>
                            <div class="col-auto">
                                <a href="#!" class="fs-13 font-weight-600"><?php echo html_escape(@$user_info->nick_name);?></a>
                            </div>
                        </div>
                        <hr>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-auto">
                                <time class="fs-13 font-weight-600 text-muted" ><?php echo html_escape(@$user_info->mobile);?></time>
                            </div>
                        </div>
                        <hr>
            ...
            <div class="col-lg-9">
                ...
                <div class="card">
                    ...
                    <?php echo form_open_multipart('dashboard/profile/update_user_info');?>
                                ...
                                <div class="row">
                                    <div class="col-md-5 pr-md-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  placeholder="Full name" required="" name="name" value="<?php echo html_escape($user_info->name); ?>" >
                                        </div>
                                    </div>
                                    <div class="col-md-3 px-md-1">
                                        <div class="form-group">
                                            <label class="font-weight-600"><?php echo display('nick_name')?></label>
                                            <input type="text" class="form-control" name="nick_name" value="<?php echo html_escape($user_info->nick_name) ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 pr-md-1">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="sex">
                                                ...
                                                <option value="male" <?php echo (html_escape($user_info->sex)=='male'?'selected':'')?>> <?php echo makeString(['male',])?></option>
                                                <option value="female" <?php echo (html_escape($user_info->sex)=='female'?'selected':'')?>> <?php echo makeString(['female',])?></option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 pr-md-1">
                                        <div class="form-group">
                                            ...
                                            <input type="number" class="form-control" name="mobile" value="<?php echo html_escape($user_info->mobile); ?>">
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="country">
                                                <?php foreach ($country as $key => $value) {?>
                                                    <option value="<?php echo html_escape($key)?>" <?php echo (html_escape($user_info->country)==html_escape($key)?'selected':''); ?>><?php echo html_escape($key)?></option>
                                                <?php }?>
                                            </select>
                                        </div>
                                    </div>
