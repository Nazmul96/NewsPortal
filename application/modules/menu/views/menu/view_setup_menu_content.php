            ...
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                ...
                <div class="tab-content" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="Category" role="tabpanel" aria-labelledby="pills-home-tab">
                        <a  href="<?php echo base_url('categories/category/add_category');?>"><i class="fa fa-plus"></i> <?php echo makeString(['add','new','category'])?></a>
                        <?php 
                            echo form_open_multipart('menu/menu/save_content_menu');
                        ?>
                    ...
                    <div class="tab-pane fade" id="Pages" role="tabpanel" aria-labelledby="pills-profile-tab">
                        <a  href="<?php echo base_url('page/page_controller/create_new_page')?>"><i class="fa fa-plus"></i> <?php echo display('add_page')?></a>
                        <?php 
                            echo form_open_multipart('menu/menu/save_page_content_menu');
                        ?>
                        <h3>Pages</h3>

                        <?php foreach($pages as $page_value){?>
                    ...
                    <div class="tab-pane fade" id="Link" role="tabpanel" aria-labelledby="pills-contact-tab">
                        <a href="javascript:void(0)" onclick="add_link(<?php echo html_escape($menu_id)?>)"><i class="fa fa-plus"></i> <?php echo display('addnewlink')?></a>
                            <?php 
                                echo form_open_multipart('menu/menu/add_link_with_content');
                            ?>
