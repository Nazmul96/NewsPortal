<?php include('common_file/__lang_list.php'); ?>
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a href="<?php echo base_url('reporter/reporters/repoter_list')?>" class="btn btn-md btn-success  float-right"><?php echo makeString(['reporter','list'])?></a>
                        </div>
                    </div>

                    <div class="card-body">
                        <?php echo form_open_multipart('reporter/reporters/update_reporter_info');?>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3 px-md-1">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" placeholder="<?php echo display('nick_name');?>" name="nick_name" value="<?php echo html_escape(@$user_info->nick_name); ?>">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-4 pr-md-1">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control" name="sex">
                                                            ...
                                                            <option value="Male" <?php echo ($user_info->sex=='Male'?'selected':'')?>> <?php echo display('male')?></option>
                                                            <option value="Female" <?php echo ($user_info->sex=='Female'?'selected':'')?>> <?php echo display('Female')?></option>
                                                        </select>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 pr-md-1">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" rows="4" name="about"><?php echo html_escape($user_info->about)?></textarea>
                                                </div>
                                            </div>
                                        </div>
