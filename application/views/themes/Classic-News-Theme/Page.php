    ...
    <div class="row">
        <div class="col-sm-8">
            <article class="content">
                ...
                <div>
                    <?php echo htmlspecialchars_decode(trim(@$pd['description']));?>
                </div>
            </article>
        </div>
                                ...
                                <div class="box-item wow fadeIn" data-wow-duration="1s">
                                    <div class="img-thumb">
                                        ...
                                        <a href="<?php echo html_escape(@$ln['news_link_'.$i]);?>" rel="bookmark">
                                            <a href="<?php echo html_escape(@$ln['default_img_'.$i]);?>" rel="bookmark"><img class="entry-thumb" src="<?php echo html_escape(@$ln['image_thumb_' . $i]); ?>" alt="" height="80" width="90"></a>
                                        </a>
                                        <?php }?>
                                    </div>
