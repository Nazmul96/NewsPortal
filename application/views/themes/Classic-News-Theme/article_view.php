            ...
            <article class="content">
                ...
                <div class="tags">
                    <ul>
                        ...
                        ?>
                        <li> <a href="<?php  echo base_url('tag/'). @$val->tag?>"><?php echo htmlspecialchars_decode(@$tag)?></a></li>
                        <?php } }?>
                                        ...
                                        <div class="col-xs-12 col-md-4 col-sm-4 padd">
                                            <div class="post-wrapper wow fadeIn" data-wow-duration="2s"><!-- image -->
                                                <div class="post-thumb">
                                                    ...
                                                    <?php } else { ?>
                                                        <a href="<?php echo html_escape(@$sn['hn']['news_link_' . $i])?>">
                                                            <img class="img-responsive" src="<?php echo html_escape(@$sn['hn']['default_img_' . $i]);?>" >
                                                        </a>
                                                    <?php }?>                                                
                                                </div>
                                            ...
                                            <div class="post-title-author-details">
                                                ...
                                                <div class="post-editor-date">
                                                    <div class="post-date">
                                                        <i class="pe-7s-clock"></i> <?php echo @$sn['hn']['post_date_as_' . $i]; ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="img-thumb">
                                        <?php if(@$mr['image_check_' . $i]!=Null){?>
                                            <a href="<?php echo html_escape(@$mr['news_link_'.$i]);?>" rel="bookmark">
                                                <img class="entry-thumb" src="<?php echo @$mr['image_thumb_' . $i]; ?>" alt="" height="80" width="90">
                                            </a>
                                        <?php } else{?>
                                            <a href="<?php echo html_escape(@$mr['news_link_'.$i]);?>" rel="bookmark">
                                                <img class="entry-thumb" src="<?php echo @$mr['default_img_' . $i]; ?>" alt="" height="80" width="90">
                                            </a>
                                        <?php }?>
                                    </div>
                            ...
                            <div class="item">
                                ...
                                <div class="date">
                                    <ul>
                                        ...
                                        <li><a><?php echo @$Editor['hn']['post_date_as_'.$i] ;?></a></li>
                                    </ul>
                                </div>
                                <?php 
