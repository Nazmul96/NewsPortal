<?php 
    ...
    $font_one = (@$dynamic_color->font_one?@$dynamic_color->font_one:'Lato');
    $font_two = (@$dynamic_color->font_two?@$dynamic_color->font_two:'Ubuntu');
...
<html lang="en">
    <head>
        ...
        <?php if(@$setting->speed_optimization==1){?>
            ...
            <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>application/views/themes/<?php echo html_escape($default_theme); ?>/web-assets/css/app.css?v=1">
        <?php } else{ ?>
    ...
    <body>
        ...
        <header>
            ...
            <div class="mobile-menu-area navbar-fixed-top hidden-sm hidden-md hidden-lg">
                <nav class="mobile-menu" id="mobile-menu"  id="mobile-menu" data-image-src="<?php echo base_url() . html_escape(@$setting->mobile_menu_image) ?>">
                    <div class="sidebar-nav">
                        <ul id="metismenu" class="nav side-menu">
                            ...
                            <li class="<?php echo  ($menu_slug!=''?'':$selected)?>" ><a href="<?php echo html_escape($bu) ?>" class="<?php echo  ($menu_slug!=''?'':$selected)?>"><?php echo display('home')?></a></li>
                            <?php
                                $i = 2;
                                foreach ($main_menu as $key => $value) {
                                    ...
                                    if($value->slug!=NULL){
                                        $slug1 = $bu.'category/'.html_escape($value->slug);
                                    }elseif ($value->link_url!=NULL) {
                                        $slug1 = html_escape($value->link_url);
                                    }else{
                                        $slug1 = $bu."#";
                                    }
