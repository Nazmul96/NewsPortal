                    ...
                    <div class="post-wrapper wow fadeIn" data-wow-duration="2s">
                        <div class="img-zoom-in sl">
                            ...
                            <a href="<?php echo html_escape(@$hn['news_link_4']);?>">
                                <img class="entry-thumb" src="<?php echo html_escape(@$hn['image_large_4'])?>" alt="<?php echo  html_escape(@$hn['image_alt_4']) ?>">
                            </a>
                            <?php } else{ ?>
                                <a href="<?php echo html_escape(@$hn['news_link_4']);?>">
                                    <img class="entry-thumb" src="<?php echo html_escape(@$hn['default_img_4'])?>" >
                                </a>
                            <?php }?>
                        </div>
                        ...
                        <div class="post-info">
                            ...
                            <h3 class="post-title post-title-size"><a href="<?php echo html_escape(@$hn['news_link_4']);?>" rel="bookmark"><?php echo htmlspecialchars_decode(@$hn['news_title_4']);?></a></h3>
                            <div class="post-editor-date">
                                <!-- post date -->
                                <div class="post-date">
                                    <i class="pe-7s-clock"></i> <?php echo html_escape(@$hn['post_date_as_4']); ?>
                                </div>
                                <!-- read more -->
                        ...
                        <div class="item">
                            <div class="post-wrapper wow fadeIn" data-wow-duration="2s">
                                ...
                                <div class=" img-zoom-in sl">
                                    ...
                                    <?php } else{ ?>
                                        <a href="<?php echo html_escape(@$hn['news_link_'.$i]);?>" rel="bookmark">
                                            <img class="entry-thumb" src="<?php echo html_escape(@$hn['default_img_'.$i])?>" alt="<?php echo  html_escape(@$hn['image_alt_'.$i]) ?>">
                                        </a>
                                    <?php }?>
                                ...
                                <div class="post-info">
                                    ...
                                    <h3 class="post-title"><a href="#" rel="bookmark"><?php echo htmlspecialchars_decode(@$hn['news_title_'.$i])?> </a></h3>
                                    <div class="post-editor-date">
                                        <!-- post date -->
                                        <div class="post-date">
                    ...
                    <div class="post-wrapper wow fadeIn" data-wow-duration="2s">
                        <div class=" img-zoom-in sl">
                            ...
                            <a href="<?php echo html_escape(@$hn['news_link_5'])?>">
                                <img class="entry-thumb" src="<?php echo html_escape(@$hn['image_large_5'])?>" alt="<?php echo  html_escape(@$hn['image_alt_5']) ?>">
                            </a>
                            <?php } else{ ?>
                                <a href="<?php echo html_escape(@$hn['news_link_5']);?>" rel="bookmark">
                                    <img class="entry-thumb" src="<?php echo html_escape(@$hn['default_img_5'])?>" alt="<?php echo  html_escape(@$hn['image_alt_5']) ?>">
                                </a>
                            <?php }?>
                        </div>
                        <div class="post-info">
                            <span class="color-5"><a href="<?php echo html_escape(@$hn['category_link_5'])?>"><?php echo html_escape(@$hn['category_name_5'])?></a> </span>
                            <h3 class="post-title post-title-size"><a href="<?php echo html_escape(@$hn['news_link_5'])?>" rel="bookmark"><?php echo htmlspecialchars_decode(@$hn['news_title_5'])?></a></h3>
                            <div class="post-editor-date">
                                <!-- post date -->
                                <div class="post-date">
                                    <i class="pe-7s-clock"></i> <?php echo html_escape(@$hn['post_date_as_5']); ?>
                                </div>
                               <!-- read more -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-sm-8">
                ...
                <!-- ad area two -->
                <div class="banner-add <?php echo (html_escape(@$lg_status_12)==0?'hidden-lg hidden-md':'')?> <?php echo (html_escape(@$sm_status_12)==0?'hidden-xs hidden-sm':'')?>"> <!-- add -->
                        ...
                        <div id="content-slide" class="owl-carousel">
                            ...
                            ?>
                                <div class="item home2-post">
                                        ...
                                        <div class="post-thumb">
                                            <?php if(@$pn['position_1']['image_check_'.$i]!=NULL){?>
                                             <a href="<?php echo html_escape(@$pn['position_1']['news_link_'.$i]); ?>">
                                                <img class="img-responsive" src="<?php echo html_escape(@$pn['position_1']['image_large_'.$i]); ?>" alt="<?php echo html_escape($pn['position_1']['image_alt_'.$i]);?>">
                                            </a>
                                            <?php } else{ ?>
                                                <a href="<?php echo html_escape(@$pn['position_1']['news_link_'.$i]);?>" rel="bookmark">
                                                    <img class="img-responsive" src="<?php echo html_escape(@$pn['position_1']['default_img_'.$i]); ?>" alt="<?php echo html_escape($pn['position_1']['image_alt_'.$i]);?>">
                                                </a>
                                            <?php }?>
                                    ...
                                    <h3><a href="<?php echo html_escape(@$pn['position_1']['news_link_'.$i]); ?>"><?php echo htmlspecialchars_decode(@$pn['position_1']['news_title_'.$i]); ?></a></h3>
                    ...
                    ?>
                            <div class="col-md-4 col-sm-4 padd">
                                <div class="home2-post">
                                    ...
                                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s"><!-- image -->
                                        <div class="post-thumb">
                                            <?php if(@$pn['position_1']['image_check_'.$i]){?>
                                                <a href="<?php echo html_escape(@$pn['position_1']['news_link_'.$i]); ?>">
                                                    <img class="img-responsive" src="<?php echo html_escape(@$pn['position_1']['image_thumb_'.$i]); ?>" alt="<?php echo html_escape($pn['position_1']['image_alt_'.$i]);?>">
                                                </a>
                                            <?php } else{ ?>
                                                <a href="<?php echo html_escape(@$pn['position_1']['news_link_'.$i]);?>" rel="bookmark">
                                                    <img class="img-responsive" src="<?php echo html_escape(@$pn['position_1']['default_img_'.$i]); ?>" alt="<?php echo html_escape($pn['position_1']['image_alt_'.$i]);?>">
                                    ...
                                    <div class="post-title-author-details">
                                        <h4><a href="<?php echo html_escape(@$pn['position_1']['news_link_'.$i]); ?>"><?php echo htmlspecialchars_decode(@$pn['position_1']['news_title_'.$i]); ?></a></h4>
                                        <div class="date">
                                            <ul>
                                                <li><?php echo display('by')?> <a title="" href="<?php echo html_escape(@$pn['position_1']['author_profile_'.$i]); ?>"><span><?php echo html_escape(@$pn['position_1']['post_by_name_'.$i]); ?></span></a> --</li>
                                                <li><a title="" href="#"><?php echo html_escape(@$pn['position_1']['post_date_as_'.$i]); ?></a></li>
                        ...
                        <div id="content-slide-2" class="owl-carousel">
                            ...
                            <div class="item">
                                <div class="row">
                                    ...
                                    <?php if(@$pn['position_2']['news_title_1']!=NULL){?>
                                        <div class="post-wrapper wow fadeIn" data-wow-duration="2s">
                                            <!-- post title -->
                                            <h3><a href="<?php echo html_escape(@$pn['position_2']['news_link_1']); ?>"><?php echo htmlspecialchars_decode(@$pn['position_2']['news_title_1']); ?></a></h3>
                                            <!-- post image -->
                                            <div class="post-thumb">
                                            <?php if(@$pn['position_2']['image_check_1']!=NULL){?>
                                                ...
                                                <?php } else{ ?>
                                                    <a href="<?php echo html_escape(@$pn['position_2']['news_link_1']);?>" rel="bookmark">
                                                        <img src="<?php echo html_escape(@$pn['position_2']['default_img_1']); ?>" class="img-responsive" alt="<?php echo html_escape($pn['position_2']['image_alt_1']);?>">
                                                    </a>
                                            <?php }?>
                                                    ...
                                                    <div class="home2-post">
                                                        ...
                                                        <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                                            ...
                                                            <a href="<?php echo html_escape(@$pn['position_2']['news_link_'.$i]); ?>">
                                                                <img src="<?php echo html_escape(@$pn['position_2']['image_thumb_'.$i]); ?>" class="img-responsive" alt="<?php echo html_escape($pn['position_2']['image_alt_'.$i]);?>">
                                                            </a>
                                                            <?php } else{ ?>
                                                                <a href="<?php echo html_escape(@$pn['position_2']['news_link_'.$i]);?>" rel="bookmark">
                                                                    <img src="<?php echo html_escape(@$pn['position_2']['default_img_'.$i]); ?>" class="img-responsive" alt="<?php echo html_escape($pn['position_2']['image_alt_'.$i]);?>">
                                                                </a>
                                                            <?php }?>
                                                        </div>
                                                        <div class="post-title-author-details">
                                                            <!-- post image -->
                                                            <h5><a href="<?php echo html_escape(@$pn['position_2']['news_link_'.$i]); ?>"><?php echo htmlspecialchars_decode(@$pn['position_2']['news_title_'.$i]); ?></a></h5>
                                                            <div class="date">
                                                                <ul>
                            ...
                            <div class="item">
                                <div class="row">
                                    <!-- main post -->
                                    <div class="col-sm-6 col-md-6">
                                    <?php if(@$pn['position_2']['news_title_6']!=NULL){?>
                                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                            <!-- post title -->
                                            <h3><a href="<?php echo html_escape(@$pn['position_2']['news_link_6']); ?>"><?php echo htmlspecialchars_decode(@$pn['position_2']['news_title_6']); ?></a></h3>
                                            <!-- post image -->
                                            <div class="post-thumb">
                                            <?php if(@$pn['position_2']['image_check_6']!=NULL){?>
                                                <a href="<?php echo html_escape(@$pn['position_2']['news_link_6']); ?>">
                                                    <img src="<?php echo html_escape(@$pn['position_2']['image_large_6']); ?>" class="img-responsive" alt="<?php echo html_escape($pn['position_2']['image_alt_6']);?>">
                                                </a>
                                            <?php } else{ ?>
                                                <a href="<?php echo html_escape(@$pn['position_2']['news_link_6']);?>" rel="bookmark">
                                                    <img src="<?php echo html_escape(@$pn['position_2']['default_img_']); ?>" class="img-responsive" alt="<?php echo html_escape($pn['position_2']['image_alt_6']);?>">
                                                </a>
                                            <?php }?>
                                            </div>
                                        </div>
                                        <div class="post-title-author-details">
                                            <div class="post-editor-date">
                                                <!-- post date -->
                                                <div class="post-date">
                                                    <i class="pe-7s-clock"></i> <?php echo html_escape(@$pn['position_2']['post_date_as_6']); ?>
                                                </div>
                                                <!-- post comment -->
                                            </div>
                                            <p>
                                    ...
                                    <div class="img-thumb">
                                        <?php if(@$ln['image_check_' . $i]!=NULL){?>
                                            <a href="<?php echo html_escape(@$ln['news_link_'.$i]);?>" rel="bookmark">
                                                <img class="entry-thumb" src="<?php echo html_escape(@$ln['image_thumb_' . $i]); ?>" alt="<?php echo html_escape(@$ln['image_alt_'.$i]);?>" height="80" width="90">
                                            </a>
                                        <?php } else{?>
                                            <a href="<?php echo html_escape(@$ln['news_link_'.$i]);?>" rel="bookmark">
                                                <img class="entry-thumb" src="<?php echo html_escape(@$ln['default_img_' . $i]); ?>" alt="<?php echo html_escape(@$ln['image_alt_'.$i]);?>" height="80" width="90">
                                            </a>
                                        <?php }?>
                                    </div>
                                    ...
                                    <div class="img-thumb">
                                        <?php if(@$mr['image_check_' . $i]!=NULL){?>
                                            <a href="<?php echo html_escape(@$mr['news_link_'.$i]);?>" rel="bookmark">
                                             <img class="entry-thumb" src="<?php echo html_escape(@$mr['image_thumb_' . $i]); ?>" alt="<?php echo html_escape(@$mr['image_alt_'.$i]);?>" height="80" width="90">
                                            </a>
                                        <?php } else{?>
                                        <a href="<?php echo html_escape(@$mr['news_link_'.$i]);?>" rel="bookmark">
                                             <img class="entry-thumb" src="<?php echo html_escape(@$mr['default_img_' . $i]); ?>" alt="<?php echo html_escape(@$mr['image_alt_'.$i]);?>" height="80" width="90">
                                        </a>
                                        <?php }?>
                                    </div>
                        ...
                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                            ...
                            <?php if(@$pn['position_3']['image_check_'.$i]){?>
                                <a href="<?php echo html_escape(@$pn['position_3']['news_link_'.$i])?>">
                                    <img class="entry-thumb" src="<?php echo html_escape(@$pn['position_3']['image_large_'.$i])?>" alt="<?php echo html_escape($pn['position_3']['image_alt_'.$i]);?>">
                                </a>
                            <?php } else{ ?>
                                <a href="<?php echo html_escape(@$pn['position_3']['news_link_'.$i])?>" rel="bookmark">
                                    <img class="entry-thumb" src="<?php echo html_escape(@$pn['position_3']['default_img_'.$i])?>" alt="<?php echo html_escape($pn['position_3']['image_alt_'.$i]);?>">
                                </a>
                            <?php }?>
                            ...
                            <div class="post-info">
                                ...
                                <h3 class="post-title"><a href="<?php echo html_escape(@$pn['position_3']['news_link_'.$i])?>" rel="bookmark"><?php echo htmlspecialchars_decode(@$pn['position_3']['news_title_'.$i])?> </a></h3>
                                <div class="post-editor-date">
                                    <div class="post-date">
                    ...
                    <div class="row">
                        ...
                        <?php if(@$home_page_positions[4]['status']==1){ ?>
                            <div class="col-sm-6 col-md-6">
                                <div class="buisness">
                                    ...
                                    <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                        <!-- post title -->
                                        <h3><a href="<?php echo html_escape(@$pn['position_4']['news_link_1'])?>"><?php echo htmlspecialchars_decode(@$pn['position_4']['news_title_1'])?></a></h3>
                                        <!-- post image -->
                                        <div class="post-thumb">
                                            <?php if(@$pn['position_4']['image_check_1']){?>
                                                <a href="<?php echo html_escape(@$pn['position_4']['news_link_1'])?>">
                                                    <img src="<?php echo html_escape(@$pn['position_4']['image_large_1'])?>" class="img-responsive" alt="<?php echo html_escape($pn['position_4']['image_alt_1']);?>">
                                                </a>
                                            <?php } else{ ?>
                                                <a href="<?php echo html_escape(@$pn['position_4']['news_link_1'])?>" rel="bookmark">
                                                    <img src="<?php echo html_escape(@$pn['position_4']['default_img_1'])?>" class="img-responsive" alt="<?php echo html_escape($pn['position_4']['image_alt_1']);?>">
                                                </a>
                                            <?php }?>
                                    ...
                                    <div class="post-title-author-details">
                                        <div class="post-editor-date">
                                            <!-- post date -->
                                            <div class="post-date">
                                                <i class="pe-7s-clock"></i> <?php echo html_escape(@$pn['position_4']['post_date_as_1'])?>
                                            </div>
                                            <!-- post comment -->
                                        </div>
                                        <p>
                                        ...
                                        <div class="img-thumb">
                                            <?php if(@$pn['position_4']['image_check_'.$i]){?>
                                                <a href="<?php echo html_escape(@$pn['position_4']['news_link_'.$i])?>" rel="bookmark">
                                                    <img class="entry-thumb" src="<?php echo html_escape(@$pn['position_4']['image_thumb_'.$i])?>" alt="<?php echo html_escape($pn['position_4']['image_alt_'.$i]);?>" height="70" width="100">
                                                </a>
                                            <?php } else{ ?>
                                                <a href="<?php echo html_escape(@$pn['position_4']['news_link_'.$i])?>" rel="bookmark">
                                                    <img class="entry-thumb" src="<?php echo html_escape(@$pn['position_4']['default_img_'.$i])?>" alt="<?php echo html_escape($pn['position_4']['image_alt_'.$i]);?>" height="70" width="100">
                                                </a>
                                            <?php }?>
                                        </div>
                                        
                                        <div class="item-details">
                                            <h3 class="td-module-title"><a href="<?php echo html_escape(@$pn['position_4']['news_link_'.$i])?>"><?php echo htmlspecialchars_decode(@$pn['position_4']['news_title_'.$i])?></a></h3>
                                            <div class="post-editor-date">
                                                <!-- post date -->
                                                <div class="post-date">
                                                    <i class="pe-7s-clock"></i> <?php echo html_escape(@$pn['position_4']['post_date_as_'.$i])?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="col-sm-6 col-md-6">
                            <div class="international">
                                ...
                                <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                    <!-- post title -->
                                    <h3><a href="<?php echo html_escape(@$pn['position_5']['news_link_1'])?>"><?php echo htmlspecialchars_decode(@$pn['position_5']['news_title_1'])?></a></h3>
                                    <!-- post image -->
                                    <div class="post-thumb">
                                        ...
                                        <?php } else{ ?>
                                            <a href="<?php echo html_escape(@$pn['position_5']['news_link_1'])?>" rel="bookmark">
                                                <img src="<?php echo html_escape(@$pn['position_5']['default_img_1'])?>" class="img-responsive" alt="<?php echo html_escape($pn['position_5']['image_alt_1']);?>">
                                            </a>
                                        <?php }?>
                                    </div>
                                </div>
                                    ...
                                    <div class="img-thumb">
                                        <?php if(@$pn['position_5']['image_check_'.$i]){?>
                                           <a href="<?php echo html_escape(@$pn['position_5']['news_link_'.$i])?>" rel="bookmark">
                                                <img class="entry-thumb" src="<?php echo html_escape(@$pn['position_5']['image_thumb_'.$i])?>" alt="<?php echo html_escape($pn['position_5']['image_alt_'.$i]);?>" height="70" width="100">
                                            </a>
                                        <?php } else{ ?>
                                            <a href="<?php echo html_escape(@$pn['position_5']['news_link_'.$i])?>" rel="bookmark">
                                                <img class="entry-thumb" src="<?php echo html_escape(@$pn['position_5']['default_img_'.$i])?>" alt="<?php echo html_escape($pn['position_5']['image_alt_'.$i]);?>" height="70" width="100">
                                            </a>
                                        <?php }?>
                                    </div>
                                    <div class="item-details">
                                        <h3 class="td-module-title"><a href="<?php echo html_escape(@$pn['position_5']['news_link_'.$i])?>"><?php echo htmlspecialchars_decode(@$pn['position_5']['news_title_'.$i])?></a></h3>
                                        <div class="post-editor-date">
                                            <!-- post date -->
                                            <div class="post-date">
                                                <i class="pe-7s-clock"></i><?php echo html_escape(@$pn['position_5']['post_date_as_'.$i])?>
                                            </div>
                                            <!-- post comment -->
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                         <?php if(@$pn['position_6']['news_title_1']!=NULL){?>
                                            <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                                <!-- post title -->
                                                <h3><a href="<?php echo html_escape(@$pn['position_6']['news_link_1'])?>"><?php echo htmlspecialchars_decode(@$pn['position_6']['news_title_1'])?></a></h3>
                                                <!-- post image -->
                                                <div class="post-thumb">
                                                    <?php if(@$pn['position_6']['image_check_1']){?>
                                                        <a href="<?php echo html_escape(@$pn['position_6']['news_link_1'])?>">
                                                            <img src="<?php echo html_escape(@$pn['position_6']['image_large_1'])?>" class="img-responsive" alt="<?php echo html_escape($pn['position_6']['image_alt_6']);?>">
                                                        </a>
                                                    <?php } else{ ?>
                                                        <a href="<?php echo html_escape(@$pn['position_6']['image_large_1'])?>" rel="bookmark">
                                                            <img src="<?php echo html_escape(@$pn['position_6']['default_img_1'])?>" class="img-responsive" alt="<?php echo html_escape($pn['position_6']['image_alt_6']);?>">
                                                        </a>
                                                    <?php }?>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            ...
                                            ?>
                                                <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                                    ...
                                                    <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                                        <?php if(@$pn['position_6']['image_check_'.$i]){?>
                                                            <a href="<?php echo html_escape(@$pn['position_6']['news_link_'.$i])?>">
                                                                <img src="<?php echo html_escape(@$pn['position_6']['image_thumb_'.$i])?>" class="img-responsive" alt="<?php echo html_escape($pn['position_6']['image_alt_'.$i]);?>">
                                                            </a>
                                                        <?php } else{ ?>
                                                            <a href="<?php echo html_escape(@$pn['position_6']['news_link_'.$i]);?>" >
                                                                <img src="<?php echo html_escape(@$pn['position_6']['default_img_'.$i])?>" class="img-responsive" alt="<?php echo html_escape($pn['position_6']['image_alt_'.$i]);?>">
                                                            </a>
                                                        <?php }?>
                                                    </div>
                                                    ...
                                                    <div class="post-title-author-details">
                                                        <!-- post image -->
                                                        <h5><a href="<?php echo html_escape(@$pn['position_6']['news_link_'.$i])?>"><?php echo htmlspecialchars_decode(@$pn['position_6']['news_title_'.$i])?></a></h5>
                                                        <div class="post-editor-date">
                                                            <!-- post date -->
                                                            <div class="post-date">
                                                                <i class="pe-7s-clock"></i> <?php echo html_escape(@$pn['position_6']['post_date_as_'.$i])?>
                                                            </div>
                                                            <!-- post comment -->
                                                        </div>
                                                    </div>
                                         ...
                                         <?php if(@$pn['position_6']['news_title_6']!=NULL){?>
                                                ...
                                                <div class="post-thumb">
                                                    <?php if(@$pn['position_6']['image_check_6']){?>
                                                        <a href="<?php echo html_escape(@$pn['position_6']['news_link_6'])?>">
                                                            <img src="<?php echo html_escape(@$pn['position_6']['image_large_6'])?>" class="img-responsive" alt="<?php echo html_escape($pn['position_6']['image_alt_6']);?>">
                                                        </a>
                                                    <?php } else{ ?>
                                                        <a href="<?php echo html_escape(@$pn['position_6']['news_link_6'])?>" rel="bookmark">
                                                            <img src="<?php echo html_escape(@$pn['position_6']['default_img_6'])?>" class="img-responsive" alt="<?php echo html_escape($pn['position_6']['image_alt_6']);?>">
                                                        </a>
                                                    <?php }?>
                                            ...
                                            <div class="post-title-author-details">
                                                <div class="post-editor-date">
                                                    <!-- post date -->
                                                    <div class="post-date">
                                                        <i class="pe-7s-clock"></i> <?php echo html_escape(@$pn['position_6']['post_date_as_6'])?>
                                                    </div>
                                                    <!-- post comment -->
                                                 </div>
                                                    ...
                                                    <?php
                                                        if (@$pn['position_7']['image_check_'.$i]!=NULL) {
                                                          echo'<img class="img-responsive" width="50" src="'.html_escape(@$pn['position_7']['image_thumb_'.$i]).'" alt="" class="thumb">';
                                                            ...
                                                            echo'<img class="img-responsive" width="50" src="'.html_escape(@$pn['position_7']['default_img_'.$i]).'" alt="" class="thumb">';
                                                        }
                                                    ?>
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-sm-4">
                 <?php if(@$home_page_positions[8]['status']==1){ ?>
                    ...
                    <div class="sports-inner">
                        ...
                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                            <!-- post title -->
                            <h3><a href="<?php echo html_escape(@$pn['position_8']['news_link_1'])?>"><?php echo htmlspecialchars_decode(@$pn['position_8']['news_title_1'])?></a></h3>
                            <!-- post image -->
                            <div class="post-thumb">
                            ...
                            <?php } else{ ?>
                                <a href="<?php echo html_escape(@$pn['position_8']['news_link_1'])?>" rel="bookmark">
                                    <img src="<?php echo html_escape(@$pn['position_8']['default_img_1'])?>" class="img-responsive" alt="<?php echo html_escape($pn['position_8']['image_alt_1']);?>">
                                </a>
                            <?php }?>
                ...
                <?php if(@$home_page_positions[9]['status']==1){?>
                    ...
                    <div class="fashion-inner">
                        ...
                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                            ...
                            <?php echo htmlspecialchars_decode(@$pn['position_9']['news_title_1'])?></a></h3>
                            <!-- post image -->
                            <div class="post-thumb">
                            ...
                            <?php } else{ ?>
                                <a href="<?php echo html_escape(@$pn['position_9']['news_link_1'])?>" rel="bookmark">
                                    <img src="<?php echo html_escape(@$pn['position_9']['default_img_1'])?>" class="img-responsive" alt="<?php echo html_escape(@$pn['position_9']['image_alt_1']);?>">
                                </a>
                            <?php }?>
                ...
                <?php if(@$home_page_positions[10]['status']==1){?>
                    ...
                    <div class="travel-inner">
                        ...
                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                            <!-- post title -->
                            <h3><a href="<?php echo html_escape(@$pn['position_10']['news_link_1'])?>"><?php echo htmlspecialchars_decode(@$pn['position_10']['news_title_1'])?></a></h3>
                            <!-- post image -->
                            <div class="post-thumb">
                            ...
                            <?php } else{ ?>
                                <a href="<?php echo html_escape(@$pn['position_10']['news_link_1'])?>" rel="bookmark">
                                    <img src="<?php echo html_escape(@$pn['position_10']['default_img_1'])?>" class="img-responsive" alt="<?php echo html_escape($pn['position_10']['image_alt_1']);?>">
                                </a>
                            <?php }?>
            ...
            <div class="row">
                ...
                <?php if(@$home_page_positions[11]['status']==1){?>
                    ...
                    <div class="food-inner">
                        ...
                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                            <!-- post title -->
                            <h3><a href="<?php echo html_escape(@$pn['position_11']['news_link_1'])?>"><?php echo htmlspecialchars_decode(@$pn['position_11']['news_title_1'])?></a></h3>
                            <!-- post image -->
                            <div class="post-thumb">
                            ...
                            <?php } else{ ?>
                                <a href="<?php echo html_escape(@$pn['position_11']['news_link_1'])?>" rel="bookmark">
                                    <img src="<?php echo html_escape(@$pn['position_11']['default_img_1'])?>" class="img-responsive" alt="<?php echo html_escape($pn['position_11']['image_alt_1']);?>">
                                </a>
                            <?php }?>
                            </div>
                        </div>
                ...
                <?php if(@$home_page_positions[12]['status']==1){?>
                    ...
                    <div class="politics-inner">
                        ...
                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                            <!-- post title -->
                            <h3><a href="<?php echo html_escape(@$pn['position_12']['news_link_1'])?>"><?php echo htmlspecialchars_decode(@$pn['position_12']['news_title_1'])?></a></h3>
                            <!-- post image -->
                            <div class="post-thumb">

                            <?php if(@$pn['position_12']['image_check_1']){?>
                                <a href="<?php echo html_escape(@$pn['position_12']['news_link_1'])?>">
                                    <img src="<?php echo html_escape(@$pn['position_12']['image_large_1'])?>" class="img-responsive" alt="<?php echo html_escape($pn['position_12']['image_alt_1']);?>">
                                </a>
                            <?php } else{ ?>
                                <a href="<?php echo html_escape(@$pn['position_12']['news_link_1'])?>" rel="bookmark">
                                    <img src="<?php echo html_escape(@$pn['position_12']['default_img_1'])?>" class="img-responsive" alt="<?php echo html_escape($pn['position_12']['image_alt_1']);?>">
                                </a>
                            <?php }?>
                ...
                <?php if(@$home_page_positions[13]['status']==1){?>
                    ...
                    <div class="health-inner">
                        ...
                        <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                            <!-- post title -->
                            <h3><a href="<?php echo html_escape(@$pn['position_13']['news_link_1'])?>"><?php echo htmlspecialchars_decode(@$pn['position_13']['news_title_1'])?></a></h3>
                            <!-- post image -->
                            <div class="post-thumb">

                                <?php if(@$pn['position_13']['image_check_1']){?>
                                    <a href="<?php echo html_escape(@$pn['position_13']['news_link_1'])?>">
                                        <img class="img-responsive" src="<?php echo html_escape(@$pn['position_13']['image_thumb_1'])?>" alt="<?php echo html_escape($pn['position_13']['image_alt_1']);?>">
                                    </a>
                                <?php } else{ ?>
                                    <a href="<?php echo html_escape(@$pn['position_13']['news_link_1'])?>" rel="bookmark">
                                        <img class="img-responsive" src="<?php echo html_escape(@$pn['position_13']['default_img_1'])?>" alt="<?php echo html_escape($pn['position_13']['image_alt_1']);?>">
                                    </a>
                                <?php }?>
                            </div>
                        </div>
                        <div class="post-title-author-details">
                            <div class="post-editor-date">
                                <!-- post date -->
                                <div class="post-date">
                                    <i class="pe-7s-clock"></i> <?php echo html_escape(@$pn['position_13']['post_date_as_1'])?>
                                </div>
                                <!-- post comment -->
                            </div>
                            <?php echo  htmlspecialchars_decode(@$pn['position_13']['short_news_1']); ?>
                                            ...
                                            <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                                ...
                                                <div class="post-thumb">
                                                    ...
                                                    <a href="<?php echo html_escape(@$pn['position_14']['news_link_'.$i])?>">
                                                        <img class="img-responsive" src="<?php echo html_escape(@$pn['position_14']['image_thumb_'.$i])?>" alt="<?php echo html_escape($pn['position_14']['image_alt_1']);?>">
                                                    </a>

                                                    <?php } else{ ?>
                                                        <a href="<?php echo html_escape(@$pn['position_14']['news_link_'.$i])?>" rel="bookmark">
                                                            <img class="img-responsive" src="<?php echo html_escape(@$pn['position_14']['default_img_'.$i])?>" alt="<?php echo html_escape($pn['position_14']['image_alt_1']);?>">
                                                        </a>
                                                    <?php }?>
                                                </div>
                                            </div>
                                            <div class="post-title-author-details">
                                                <h4><a href="<?php echo html_escape(@$pn['position_14']['news_link_'.$i])?>"><?php echo htmlspecialchars_decode(@$pn['position_14']['news_title_'.$i])?></a></h4>
                                                <div class="post-editor-date">
                                                    <div class="post-date">
                                                        <i class="pe-7s-clock"></i> <?php echo html_escape(@$pn['position_14']['post_date_as_'.$i])?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-xs-6 col-md-4 col-sm-4 padd">
                                            <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                                ...
                                                <div class="post-thumb">
                                                    ...
                                                    <?php } else{?>
                                                        <a href="<?php echo html_escape(@$pn['position_14']['news_link_'.$i])?>">
                                                            <img class="img-responsive" src="<?php echo html_escape(@$pn['position_14']['default_img_'.$i])?>" alt="">
                                                        </a>
                                                    <?php }?>
                                                </div>
