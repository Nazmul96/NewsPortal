        ...
        <div class="col-md-12 col-sm-12">
                ...
                for ($i = 1; $i <= 4; $i++) {
                    ...
                    <div class="post-style1">
                        ...
                        if ($pn['image_check_' . $i]!=NULL) {
                            echo'<a href="'. html_escape($pn['news_link_'.$i]).'"><img src="'.html_escape(@$pn['image_large_' . $i]).'" class="img-responsive" alt="'.html_escape(@$pn['image_alt_' . $i]).'"></a>';
                        } else {
                             echo'<a href="'. html_escape($pn['news_link_'.$i]).'"><img src="'.html_escape(@$pn['default_img_' . $i]).'" class="img-responsive" alt="'.html_escape(@$pn['default_img_' . $i]).'"></a>';
                        }
                        ?>
                        ...
                        <!-- post title -->
                        <h3><a href="<?php echo @$pn['news_link_'.$i];?>"><?php echo htmlspecialchars_decode(@$pn['news_title_'.$i]);?></a></h3>
                        <div class="post-title-author-details">
                            <div class="date">
                                <ul>
                                    ...
                                    <li><a title="" href="#"><?php echo html_escape(@$pn['post_date_as_'.$i]);?></a> </li>
                                </ul>
                            </div>
            ...
            <div class="col-sm-3">
                ...
                <div class="post-style1">
                    ...
                    <?php
                    if ($pn['image_check_' . $i]!=NULL) {
                        echo'<a href="'.html_escape($pn['news_link_'.$i]).'"><img src="'.html_escape(@$pn['image_thumb_' . $i]).'" class="img-responsive" alt="'.html_escape(@$pn['image_alt_' . $i]).'"></a>';
                    } else {
                         echo'<a href="'.html_escape($pn['news_link_'.$i]).'"><img src="'.html_escape(@$pn['default_img_' . $i]).'" class="img-responsive" alt="'.html_escape(@$pn['image_alt_' . $i]).'"></a>';
                    }
                    ?>
                    </div>
                    <!-- post title -->
                    <h4><a href="<?php echo html_escape(@$pn['news_link_'.$i]);?>"><?php echo htmlspecialchars_decode(@$pn['news_title_'.$i]);?></a></h4>
                    <div class="post-title-author-details">
                        <div class="date">
                            <ul>
                                <li><?php echo display('by')?> <a title="" href="#"><span><?php echo html_escape(@$pn['post_by_name_'.$i]);?></span></a> --</li>
                                <li><a title="" href="#"><?php echo @$pn['post_date_as_'.$i];?></a></li>
                            </ul>
                        </div>
                        <?php echo htmlspecialchars_decode(@$pn['short_news_' . $i]);?>
                        <?php echo '<a href="' . html_escape(@$pn['news_link_' . $i]) . '"> '.display('read_more').'</a>'; ?>
                ...
                <div class="widget-slider-inner">
                    ...
                    <div id="widget-slider" class="owl-carousel owl-theme">
                      ...
                      <!-- widget item -->
                        ...
                        <?php } else{?>
                            <a href="<?php echo html_escape(@$Editor['hn']['news_link_'.$i])?>"><img src="<?php echo html_escape(@$Editor['hn']['default_img_'.$i])?>" alt=""></a>
                        <?php } ?>
