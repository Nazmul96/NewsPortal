                    ...
                    <div class="hidden-xs col-sm-3 col-padding">
                        ...
                        ?>
                            ...
                            <div class="post-wrapper post-grid-1 wow fadeIn" data-wow-duration="2s">
                                    ...
                                    <?php
                                        if (@$hn['image_check_'.$i]!=NULL){
                                            echo'<a href="'.html_escape(@$hn['news_link_'.$i]).'">
                                                    <img class="entry-thumb" src="'. html_escape(@$hn['image_thumb_'.$i]).'" alt="'.html_escape(@$hn['image_alt_'.$i]).'">
                                                </a>';
                                        } else {
                                           echo'<a href="'.html_escape(@$hn['news_link_'.$i]).'">
                                                    <img class="entry-thumb" src="'. html_escape(@$hn['default_img_'.$i]).'" alt="'.html_escape(@$hn['default_img_'.$i]).'">
                                                </a>';
                                        }
                                    ?>  
                                ...
                                <div class="post-info">
                                    <h3 class="post-title post-title-size"><a href="<?php echo html_escape(@$hn['news_link_'.$i]);?>" rel="bookmark"><?php echo htmlspecialchars_decode(@$hn['news_title_'.$i]);?> </a></h3>
                            ...
                            <div class="img-zoom-in">
                                ...
                                <a  href="<?php echo html_escape(@$hn['news_link_1']);?>">
                                    ...
                                    <?php if (@$hn['image_check_1']!=NULL) { ?>
                                        <img  src="<?php echo  html_escape(@$hn['image_large_1']) ?>" alt="<?php echo  html_escape(@$hn['image_alt_1']) ?>">
                                    <?php  } else { ?>
                                        <img  src="<?php echo  html_escape(@$hn['default_img_1']) ?>" alt="<?php echo  html_escape(@$hn['image_alt_1']) ?>">
                                    <?php  }?> 
                                </a>
                            </div>
                            ...
                            <div class="post-wrapper post-grid-4 wow fadeIn " data-wow-duration="2s">
                                <div class="img-zoom-in">
                                    <?php
                                        if (@$hn['image_check_'.$i]!=NULL){
                                            echo'<a href="'.html_escape(@$hn['news_link_'.$i]).'">
                                                    <img class="entry-thumb" src="'. html_escape(@$hn['image_thumb_'.$i]).'" alt="'.html_escape(@$hn['image_alt_1']).'">
                                                </a>';
                                        } else {
                                            echo'<a href="'.html_escape(@$hn['news_link_'.$i]).'">
                                                    <img class="entry-thumb" src="'. html_escape(@$hn['default_img_'.$i]).'">
                                                </a>';
                                        }
                                    ?>  
                                    ...
                                    <div class="post-thumb">
                                            <?php
                                                ...
                                                echo' <a href="'.html_escape(@$pn['position_1']['news_link_'.$i]).'">
                                                            <img class="img-responsive" src="'. html_escape(@$pn['position_1']['image_thumb_'.$i]).'" alt="'.html_escape($pn['position_1']['image_alt_'.$i]).'">
                                                        </a>';
                                                } else {
                                                    echo' <a href="'.html_escape(@$pn['position_1']['news_link_'.$i]).'">
                                                            <img class="img-responsive" src="'. html_escape(@$pn['position_1']['default_img_'.$i]).'">
                                                        </a>';
                                                }
                                            ?>
                                            <div class="overlay">
                                            ...
                                            <?php
                                                if (@$pn['position_1']['image_check_'.$i]!=NULL) {
                                                  echo' <a href="'.html_escape(@$pn['position_1']['news_link_'.$i]).'">
                                                    ...
                                                    echo' <a href="'.html_escape(@$pn['position_1']['news_link_'.$i]).'">
                                                            <img class="img-responsive" src="'. html_escape(@$pn['position_1']['default_img_'.$i]).'" alt="'.html_escape($pn['position_1']['image_alt_'.$i]).'">
                                                        </a>';
                                                ...
                                                <a href="<?php echo html_escape(@$pn['position_2']['news_link_1']); ?>">
                                                    ...
                                                    <?php
                                                        if (@$pn['position_2']['image_check_1']) {
                                                          echo'<img class="img-responsive" src="'.html_escape(@$pn['position_2']['image_thumb_1']).'" alt="'.html_escape($pn['position_2']['image_alt_1']).'">';
                                                        } else {
                                                            echo'<img class="img-responsive" src="'.html_escape(@$pn['position_2']['default_img_1']).'" alt="'.html_escape($pn['position_2']['image_alt_1']).'">';
                                                        }
                                                    ?>
                                                    <div class="overlay">
                                                    ...
                                                    <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                                        <?php
                                                            if (@$pn['position_2']['image_check_'.$i]!=NULL) {
                                                                echo'<img class="img-responsive" src="'. html_escape($pn['position_2']['image_thumb_'.$i]).'" alt="'.html_escape($pn['position_2']['image_alt_'.$i]).'">';
                                                            } else {
                                                                echo'<img class="img-responsive" src="'. html_escape($pn['position_2']['default_img_'.$i]).'" alt="'.html_escape($pn['position_2']['image_alt_'.$i]).'">';
                                                            }
                                                        ?>
                                                            <div class="overlay">
                                        ...
                                        <div class="post-wrapper wow fadeIn effects" data-wow-duration="2s">
                                            ...
                                            <div class="post-thumb">
                                                <a href="<?php echo html_escape(@$pn['position_2']['news_link_6']); ?>">
                                                    <?php if(@$pn['position_2']['image_check_6']){?>
                                                        <img src="<?php echo html_escape(@$pn['position_2']['image_large_6']); ?>" class="img-responsive" >
                                                    <?php }else{?>
                                                        <img src="<?php echo html_escape(@$pn['position_2']['default_img_6']); ?>" class="img-responsive" >
                                                    <?php } ?>
                                                    <div class="overlay">
                                            ...
                                            <div class="post-title-author-details">
                                                <div class="post-editor-date">
                                                    <!-- post date -->
                                                    <div class="post-date">
                                                        <i class="pe-7s-clock"></i><?php echo html_escape(@$pn['position_1']['post_date_as_6']); ?>
                                                    </div>
                                                    <!-- post comment -->
                                                </div>
                                            </div>
                             ...
                             <?php for($i=1; $i<=5; $i++){ 
                                ...
                                <div class="box-item">
                                    <div class="img-thumb">
                                        ...
                                        <?php } else{?>
                                         <a href="<?php echo html_escape(@$mr['news_link_'.$i]);?>" rel="bookmark"><img class="entry-thumb" src="<?php echo html_escape(@$mr['default_img_' . $i]); ?>" alt="<?php echo html_escape(@$mr['image_alt_'.$i])?>" height="80" width="90"></a>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <div class="post-style1">
                                ...
                                <?php
                                    if(@$pn['position_3']['image_check_'.$i]!=NULL) {
                                      ...
                                      <img class="img-responsive" src="'.html_escape(@$pn['position_3']['image_thumb_'.$i]).'">
                                        ...
                                        echo'<a href="'.html_escape(@$pn['position_3']['news_link_'.$i]).'" class="video-img-icon"><i class="fa fa-play"></i>
                                      <img class="img-responsive" src="'.html_escape(@$pn['position_3']['default_img_'.$i]).'">
                                      </a>';
                                    }
                                ?>
                            ...
                            <!-- post title -->
                            <h3><a href="<?php echo html_escape(@$pn['position_3']['news_link_'.$i])?>"><?php echo htmlspecialchars_decode(@$pn['position_3']['news_title_'.$i])?></a></h3>
                            <div class="post-title-author-details">
                                <div class="date">
                                    <ul>
                                    ...
                                    <div class="post-thumb">
                                            <?php
                                                if (@$pn['position_4']['image_check_1']) {
                                                  echo'<img class="img-responsive" src="'.html_escape(@$pn['position_4']['image_thumb_1']).'" alt="'.html_escape($pn['position_4']['image_alt_1']).'">';
                                                } else {
                                                  echo'<img class="img-responsive" src="'.html_escape(@$pn['position_4']['default_img_']).'" alt="'.html_escape($pn['position_4']['image_alt_1']).'">';
                                                }
                                            ?>
                                        ...
                                        <div class="img-thumb">
                                                ...
                                                <?php
                                                    if (@$pn['position_4']['image_check_'.$i]) {
                                                        echo'<img class="entry-thumb" src="'.html_escape(@$pn['position_4']['image_thumb_'.$i]).'" alt="'.html_escape($pn['position_4']['image_alt_'.$i]).'"  height="70" width="100">';
                                                    } else {
                                                        echo'<img class="entry-thumb" src="'.html_escape(@$pn['position_4']['default_img_'.$i]).'" alt="'.html_escape($pn['position_4']['image_alt_'.$i]).'"  height="70" width="100">';
                                                    }
                                                ?>
                                    ...
                                    <div class="post-thumb">
                                            ...
                                            <?php
                                                if (@$pn['position_5']['image_check_1']) {
                                                  echo'<img class="img-responsive" src="'.html_escape(@$pn['position_5']['image_thumb_1']).'" alt="'.html_escape($pn['position_5']['image_alt_1']).'">';
                                                } else {
                                                  echo'<img class="img-responsive" src="'.html_escape(@$pn['position_5']['default_img_1']).'" alt="'.html_escape($pn['position_5']['image_alt_1']).'">';
                                                }
                                            ?>
                                    ...
                                    <div class="img-thumb">
                                            ...
                                            <?php
                                                if (@$pn['position_5']['image_check_'.$i]!=NULL) {
                                                  echo'<img class="entry-thumb" src="'.html_escape(@$pn['position_5']['image_thumb_'.$i]).'" alt="'.html_escape($pn['position_5']['image_alt_'.$i]).'"  height="70" width="100">';
                                                } else {
                                                  echo'<img class="entry-thumb" src="'.html_escape(@$pn['position_5']['default_img_'.$i]).'" alt="'.html_escape($pn['position_5']['image_alt_'.$i]).'"  height="70" width="100">';
                                                }
                                            ?>
                                            <div class="overlay">
                                                ...
                                                <div class="post-thumb">
                                                    <?php
                                                        if (@$pn['position_6']['image_check_1']!=NULL) {
                                                          echo'<img class="img-responsive" src="'.html_escape(@$pn['position_6']['image_large_1']).'" alt="'.html_escape($pn['position_6']['image_alt_1']).'">';
                                                        } else {
                                                          echo'<img class="img-responsive" src="'.html_escape(@$pn['position_6']['default_img_1']).'" alt="'.html_escape($pn['position_6']['image_alt_1']).'">';
                                                        }
                                                    ?>
                                                    ...
                                                    <div class="post-thumb wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                                                        ...
                                                        <?php
                                                            if (@$pn['position_6']['image_check_'.$i]!=NULL) {
                                                              echo'<img class="img-responsive" src="'.html_escape(@$pn['position_6']['image_thumb_'.$i]).'" alt="'.html_escape($pn['position_6']['image_alt_'.$i]).'">';
                                                            } else {
                                                              echo'<img class="img-responsive" src="'.html_escape(@$pn['position_6']['default_img_'.$i]).'" alt="'.html_escape($pn['position_6']['image_alt_'.$i]).'">';
                                                            }
                                                        ?>
                                                        <div class="overlay">
                                                ...
                                                <div class="post-thumb">
                                                    <?php
                                                        if (@$pn['position_6']['image_check_6']!=NULL) {
                                                          echo'<img class="img-responsive" src="'.html_escape(@$pn['position_6']['image_large_6']).'" alt="'.html_escape($pn['position_6']['image_alt_6']).'">';
                                                        } else {
                                                          echo'<img class="img-responsive" src="'.html_escape(@$pn['position_6']['default_img_6']).'" alt="'.html_escape($pn['position_6']['image_alt_6']).'">';
                                                        }
                                                    ?>
                                                    <div class="overlay">
                    ...
                    <div class="widget-slider-inner">
                        ...
                        <div id="widget-slider" class="owl-carousel owl-theme">
                           ...
                           for($i=1;$i<=3;$i++){
                            ...
                            ?>
                                <div class="item">
                                    <a href="<?php echo @@$pn['position_8']['news_link_'.$i]?>">
                                    <?php
                                        if (@@$pn['position_8']['image_check_'.$i]!=NULL) {
                                              echo'<img  src="'. html_escape(@@$pn['position_8']['image_thumb_'.$i]).'" alt="">';
                                            } else {
                                              echo'<img  src="'. html_escape(@@$pn['position_8']['default_img_'.$i]).'" alt="">';
                                            }
                                        ?>
                                    </a>
                                    <h4><a href="<?php echo @@$pn['position_8']['news_link_'.$i]?>"><?php echo htmlspecialchars_decode(@@$pn['position_8']['news_title_'.$i])?></a></h4>
                                    <div class="date">
                                        <ul>
                                            <li><?php echo display('by')?><a title="" href="<?php echo html_escape(@$pn['position_8']['author_profile_'.$i]); ?>"><span><?php echo html_escape(@@$pn['position_8']['post_by_name_'.$i])?></span></a> --</li>
                                            <li><a title="" href="#"><?php echo html_escape(@$pn['position_8']['post_date_as_'.$i])?></a></li>
                                        </ul>
                                    </div>
                                           ...
                                           <small class="author"><br><?php echo @$pn['position_7']['post_by_name_'.$i]?></small></p>
                                            ...
                                            <?php
                                                if (@$pn['position_7']['image_check_'.$i]!=NULL) {
                                                    ...
                                                    echo'<img class="img-responsive"  src="'.html_escape(@$pn['position_7']['default_img_'.$i]).'" width="70" alt="">';
                                                }
                                            ?>
                                                </a>
                                       </li>
