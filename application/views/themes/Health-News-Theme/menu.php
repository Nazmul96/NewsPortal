...
?>
            ...
            <div class="top_banner_wrap mt-0">
                <div class="container">
                    <div class="row">
                        <div class="col-xs-12 col-md-4 col-sm-4">
                            <div class="header-logo mx-0">
                                <!-- logo -->
            ...
            <!-- navber -->
            <nav class="d-md-block d-none header-sticky navbar">
                <div class="container">
                    <div class=" navbar-collapse">
                        <ul class="flex-row flex-wrap nav navbar-nav gap-2">
                            <li class="<?php echo html_escape(@$selecte);?>"><a href="<?php echo html_escape($bu) ?>" class="category01 active text-decoration-none"><?php echo display('home')?></a></li>
                            <?php
                            ...
                            foreach ($main_menu as $key => $value) {
                                ...
                                if ($num_rows1) {
                                    ...
                                    if(@$value->parents_id>0){
                                        ...
                                        echo '<li class="'.(($value->slug == $menu_slug) ? @$selected : '').'"> <a  href="' . $slug1 . '/" class="text-decoration-none category0 ' . $i++ . '">' . html_escape($value->menu_lavel) . '</a>';
                                    }            
                                }
                                echo '</li>';
                            }
