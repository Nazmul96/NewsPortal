...
<html lang="en">
    <head>
        ...
        <?php } ?>
        <!-- font awesome -->
        <link rel="stylesheet" href="<?php echo base_url(); ?>application/views/themes/<?php echo html_escape($default_theme); ?>/web-assets/plugins/font-awesome/css/font-awesome.min.css">
