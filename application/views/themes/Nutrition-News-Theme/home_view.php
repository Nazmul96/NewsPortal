                        ...
                        <div class="post-wrapper post-grid-1 wow fadeIn" data-wow-duration="2s">
                            ...
                            <div class="img-zoom-in">
                                ...
                                <a href="<?php echo html_escape(@$hn['news_link_'.$i]);?>">
                                    <img class="entry-thumb" src="<?php echo html_escape(@$hn['image_thumb_'.$i])?>" alt="<?php echo  html_escape(@$hn['image_alt_'.$i]) ?>">
                                </a>
                                <?php } else{ ?>
                            ...
                            <div class="post-wrapper post-grid-3 wow fadeIn" data-wow-duration="2s">
                                ...
                                <div class="post-info">
                                    ...
                                    <div class="post-editor-date">
                                        <!-- post date -->
                                        <div class="post-date">
                                            <i class="pe-7s-clock"></i> <?php echo @$hn['post_date_as_1']; ?>
                                        </div>
                                        <!-- post comment -->
                                        <!-- read more -->
                                    <?php if(@$hn['video_'.$i]!=NULL) {?>
                        ...
                        <div class="post-wrapper post-grid-4 wow fadeIn" data-wow-duration="2s">
                            ...
                            <div class="post-info">
                                ...
                                <div class="post-editor-date">
                                    <!-- post date -->
                                    <div class="post-date">
                                        <i class="pe-7s-clock"></i> <?php echo $hn['post_date_as_' . $i]; ?>
                                    </div>
                                    <!-- read more -->
                                    <?php if(@$hn['video_'.$i]!=NULL) {?>
                                        <a class="playvideo pull-right" href="<?php echo html_escape(@$hn['news_link_'.$i]);?>"><i class="fa fa-play-circle-o"></i></a>
                ...
                ?>
                    ...
                    <?php if(@$home_page_positions[2]['status']==1){ ?>
                        <section class="politics_wrapper">
                            <h3 class="category-headding "><a href="<?php echo base_url('category/').$pn['position_2']['category_1']?>"><?php echo html_escape($home_page_positions[2]['cat_name']);?></a></h3>
                            <div class="headding-border"></div>
                            <div class="row">
                                            ...
                                            <?php if(@$pn['position_2']['image_check_1']!=NULL){?>
                                                <div class="home2-post">
                                                    ...
                                                    <div class="post-title-author-details">
                                                        <div class="date">
                                                            <ul>
                                                                <li><?php echo display('by')?> <a title="" href="#"><span><?php echo html_escape(@$pn['position_2']['post_by_name_1']); ?></span></a> --</li>
                                            ...
                                            <div class="col-sm-6 col-md-6">
                                                <div class="home2-post">
                                                    ...
                                                    <div class="post-title-author-details">
                                                        <div class="date">
                                                            <ul>
                                                                <li><?php echo display('by')?> <a title="" href="#"><span><?php echo html_escape(@$pn['position_2']['post_by_name_6']); ?></span></a> --</li>
                                                                <li><a title="" href="#"><?php echo html_escape(@$pn['position_2']['post_date_as_6']); ?></a> </li>
                                                    ...
                                                    <div class="col-xs-6 col-md-6 col-sm-6 post-padding">
                                                        <div class="home2-post">
                                                            ...
                                                            <div class="post-title-author-details">
                                                                ...
                                                                <div class="date">
                                                                    <ul>
                                                                        <li><a title="" href="#"><span><?php echo html_escape(@$pn['position_2']['post_by_name_'.$i]); ?></span></a> --</li>
                                                                        <li><a title="" href="#"><?php echo html_escape(@$pn['position_2']['post_date_as_'.$i]); ?></a></li>
                                                                    </ul>
                                                                </div>
                                                            </div>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <h3 class="category-headding ">
                            <a href="<?php echo base_url('category/').@$pn['position_3']['category_1']?>">
                    ...
                    <div class="col-sm-4">
                        <div class="post-style1">
                            <div class="post-wrapper wow fadeIn" data-wow-duration="1s">
                                ...
                                <?php if(@$pn['position_3']['image_check_'.$i]!=NULL){?>
                                    <a href="<?php echo html_escape(@$pn['position_3']['news_link_'.$i])?>" class="video-img-icon">
                                     <i class="fa fa-play"></i> <img src="<?php echo html_escape(@$pn['position_3']['image_thumb_'.$i])?>" alt="<?php echo html_escape(@$pn['position_3']['image_alt_'.$i])?>">
                                    </a>
                                <?php } else{?>
                                 <a href="<?php echo html_escape(@$pn['position_3']['news_link_'.$i])?>" class="video-img-icon">
                            ...
                            <div class="post-title-author-details">
                                <div class="date">
                                    <ul>
                                        <li><img src="<?php echo html_escape(@$pn['position_3']['post_by_image_'.$i])?>" class="img-responsive" alt="<?php echo html_escape(@$pn['position_3']['image_alt_'.$i])?>"></li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-sm-8">
                        ...
                        <!-- ad area five -->
                        <div class="banner-add <?php echo (@$lg_status_15==0?'hidden-lg hidden-md':'')?> <?php echo (@$sm_status_15==0?'hidden-xs hidden-sm':'')?>">
                            <?php echo @$home_15;?>
                        </div>
                        ...
                        <div class="articale-list">
                            <h3 class="category-headding ">
                                <a href="<?php echo base_url('category/').$pn['position_4']['category_1']?>">
                                ...
                                <div class="post-style2 wow fadeIn" data-wow-duration="1s">
                                    ...
                                    <?php if(@$pn['position_4']['image_check_'.$i]!=NULL){?>
                                        <a href="<?php echo html_escape(@$pn['position_4']['news_link_'.$i])?>">
                                            <img src="<?php echo html_escape(@$pn['position_4']['image_thumb_'.$i])?>" alt="<?php echo html_escape(@$pn['position_4']['image_alt_'.$i])?>"></a>
                                    <?php } else{?>
                    ...
                    <div class="col-sm-4 left-padding">
                        ...
                        <div class="widget-slider-inner">
                            <h3 class="category-headding "><a href="<?php echo base_url('category/').html_escape($pn['position_6']['category_1'])?>"><?php echo html_escape(@$home_page_positions[6]['cat_name']); ?></a></h3>
                            <div class="headding-border"></div>
