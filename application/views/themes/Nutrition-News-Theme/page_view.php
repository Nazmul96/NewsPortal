            ...
            for ($i = 1; $i <= 8; $i++) {
                ...
                <div class="post-style2 wow fadeIn" data-wow-duration="1s">
                    ...
                    if (@$pn['image_check_' . $i]!=NULL) {
                        echo'<a href="'.html_escape($pn['news_link_'.$i]).'"><img src="'.html_escape(@$pn['image_thumb_' . $i]).'" alt="'.html_escape(@$pn['image_alt_' . $i]).'"></a>';
                    } else {
                    ...
                    <div class="post-style2-detail">
                        <h3><a href="<?php echo html_escape(@$pn['news_link_'.$i]);?>"><?php echo htmlspecialchars_decode(@$pn['news_title_' . $i]); ?></a></h3>
                        <div class="date">
                            <ul>
                                ...
                                <li><?php echo @$pn['post_date_as_' . $i]; ?></li>
                            </ul>
                        </div>
                        <!-- news -->
