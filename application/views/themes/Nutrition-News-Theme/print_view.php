...
<body>
    ...
    <div class="printpage">	
        <div class="header"><img src="<?php echo html_escape($bu).html_escape(@$setting->logo);?>" height="75" alt="<?php echo html_escape(@$setting->website_title);?>"  title="<?php echo htmlspecialchars_decode(@$setting->website_title);?>" /></div>
    	...
    	<div class="news">
            ...
            if ($videos) {
              ...
              echo'<img src="'.$bu.'/uploads/'.html_escape($image).'" align="left" width="400" title="'.html_escape(@$setting->website_title).'" alt="'.html_escape(@$setting->website_title).'" />';
            }
            ?>  
    	...
    	<div class="footer">
            <div class="fc_left">
                ...
                <img src="<?php echo html_escape($bu).@$setting->logo; ?>" height="35" title="<?php echo html_escape(@$setting->website_title);?>" alt="<?php echo html_escape(@$setting->website_title);?>" />
                </a>
