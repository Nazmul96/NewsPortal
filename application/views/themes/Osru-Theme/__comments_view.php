                         ...
                         <?php echo form_open('Comments_controller/comments', 'id="CommentForm"');?>
                            <div class="comment-body">
                                <div class="comment-as">
                                    <span class="com-title"><?php echo display('comment')?> <?php echo display('as')?>:</span>
                                    ...
                                    <div class="dropdown main-nav">
                                        ...
                                        <?php } else{?>
                                            ...
                                            <button class="btn btn-com dropdown-toggle" type="button" data-toggle="dropdown"><?php echo display('sign_in')?>
                                                <span class="caret"></span></button>
                                            <ul class="dropdown-menu">
                                                <li><a href="javascript:void(0)" data-toggle="modal" data-target="#user-modal2" class="cd-signin" ><?php echo display('sign_in')?></a></li>
                                            </ul>
                                ...
                                <li>
                                    <div class="comment-main-level">
                                        ...
                                        <div class="comment-avatar">
                                            ...
                                            <img src="<?php echo base_url(). html_escape($comment->photo);?>" class="img-responsive" alt="">
                                            <?php } else{ ?>
                                            <img src="<?php echo base_url();?>uploads/user/demo-pic.png" class="img-responsive" alt="">
                                            <?php } ?>
                                        </div>
                                        ...
                                        <div class="comment-box">
                                            ...
                                            <div class="comment-content">
                                                <?php echo html_escape($comment->comments)?>
                                            </div>
                                    ...
                                    <ul class="comments-list reply-list">
                                        ...
                                        <li>
                                            ...
                                            <div class="comment-box">
                                                ...
                                                <div class="comment-content">
                                                   <?php echo html_escape(trim($reply->comments))?>
                                                </div>
