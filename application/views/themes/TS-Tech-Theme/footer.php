...
<footer>
                                        ...
                                        <?php
                                            $bu = base_url();
                                                ...
                                                foreach ($cat_menus as $key => $value) {
                                                    if($value->slug!=NULL){
                                                        $slug1 = $bu.'category/'.html_escape(strip_tags($value->slug));
        ...
        <?php $virsion='1.2.0'; if($setting->speed_optimization==1){?>
        ...
        <?php } else{ ?>
            ...
            <!-- custom js -->
            <script src="<?php echo base_url(); ?>application/views/themes/<?php echo html_escape($default_theme); ?>/web-assets/js/custom.js?<?php echo version() ?>"></script>
        ...
        <script src="<?php echo base_url(); ?>application/views/themes/<?php echo html_escape($default_theme); ?>/web-assets/js/lazyload.min.js"></script>
          <script>
