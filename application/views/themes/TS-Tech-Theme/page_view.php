    ...
    <div class="row">
                    ...
                    ?>
                        ...
                        <div class="post-style1">
                            ...
                            <div class="post-title-author-details">
                                <div class="date">
                                    <ul>
                                        <li><img src="<?php echo html_escape(@$pn['post_by_image_'.$i]);?>" class="img-responsive" alt="<?php echo html_escape(@$pn['post_by_name_'.$i]);?>"></li>
        ...
        ?>
            ...
            <aside class="col-sm-4 left-padding">
                ...
                <?php if (@$social_page->fb && ($social_page->mobile_status=='1')) { ?>                
                                   ...
                                   <a href="<?php echo html_escape(@$Editor['hn']['news_link_'.$i])?>">
                                    <?php
                                        if (@$Editor['hn']['image_check_'.$i]) {
                                                echo'<img  src="'. html_escape(@$Editor['hn']['image_thumb_'.$i]).'" alt="'. html_escape(@$Editor['hn']['image_alt_'.$i]).'">';
                                            } else {
