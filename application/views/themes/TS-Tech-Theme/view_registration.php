                                    ...
                                    <div class="col-sm-6">
                                        <div class="social_icon">
                                            <div class="social_icon_box social_icon_box_1">
                                                ...
                                                <a href="<?php echo html_escape($this->facebook->login_url()); ?>" class="social_info"><?php echo display('login_with_facebook')?></a>
                                            </div>
                                        </div>
                                    </div>
                                    <?php } ?>
                    ...
                    <div class="col-sm-6">
                        <div class="register-form-inner">
                            ...
                            <?php echo form_open('registration/create_user')?>
                                ...
                                <label><?php echo display('email')?> <sup>*</sup></label>
                                <input type="email" class="form-control" value="<?php echo set_value('email'); ?>" id="name_email_2" name="email" placeholder="<?php echo display('email')?>">
                                <label><?php echo display('password')?> <sup>*</sup></label>
