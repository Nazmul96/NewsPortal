                            ...
                            <a href="<?php echo base_url()?>" target="__banck" class="btn btn-sm btn-success text-whait"><i class="fa fa-eye"></i>  Website</a> &nbsp;&nbsp;&nbsp;
                                ...
                                <li class="nav-item dropdown user-menu">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" >
                                        ...
                                        <a href="<?php echo base_url(); ?>users/user_profile" class="dropdown-item"><i class="typcn typcn-user-outline"></i><?php echo display('my_profile')?></a>
                                        <a href="<?php echo base_url(); ?>users/user_profile/change_password" class="dropdown-item"><i class="typcn typcn-cog-outline"></i> <?php echo display('password_change')?></a>
