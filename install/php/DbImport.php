...
{ 
    ...
    private $table_name = 'user_info';      //Login Table Name
    private $table_fields = array('email', 'password','user_type','status'); // Table Field Names
    private $field_values = array('{input}', '{input}',3,1); // Table Field Values
